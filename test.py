...
class SauceDemoTest(unittest.TestCase):
    ...
    def test_login_and_checkout(self):
        ...
        first_name_input.send_keys('Harry')  # Enter the first name
        sleep(1)
        last_name_input.send_keys('Gunawan')  # Enter the last name
        sleep(1)
        postal_code_input.send_keys('20032')  # Enter the postal code
        sleep(1)
